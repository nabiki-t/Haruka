...
type PRManager_Test1 () =
    ...
    let cdesForIsBlockedByPersistentReservation : ( bool * bool * bool * bool * bool * ICDB )[] = 
        [|
            ...
            false, true,  false, false, true,  ( { OperationCode = 0x34uy; IMMED = false; LogicalBlockAddress = 0UL; PrefetchLength = 0u; GroupNumber = 0uy; Control = 0uy; } : PreFetchCDB );
            false, true,  false, false, true,  ( { OperationCode = 0x90uy; IMMED = false; LogicalBlockAddress = 0UL; PrefetchLength = 0u; GroupNumber = 0uy; Control = 0uy; } : PreFetchCDB );
            false, true,  false, false, true,  ( { OperationCode = 0x08uy; RdProtect = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; TransferLength = 0u; GroupNumber = 0uy; Control = 0uy; } : ReadCDB );
            false, true,  false, false, true,  ( { OperationCode = 0x28uy; RdProtect = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; TransferLength = 0u; GroupNumber = 0uy; Control = 0uy; } : ReadCDB );
            false, true,  false, false, true,  ( { OperationCode = 0xA8uy; RdProtect = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; TransferLength = 0u; GroupNumber = 0uy; Control = 0uy; } : ReadCDB );
            false, true,  false, false, true,  ( { OperationCode = 0x88uy; RdProtect = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; TransferLength = 0u; GroupNumber = 0uy; Control = 0uy; } : ReadCDB );
            false, true,  false, false, true,  ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x0009us; RDPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; ExpectedInitialLogicalBlockReferenceTag = 0u; ExpectedLogicalBlockApplicationTag = 0us; LogicalBlockApplicationTagMask = 0us; TransferLength = 0u; } : Read32CDB );
            false, false, false, false, false, ( { OperationCode = 0x25uy; ServiceAction = 0x00uy; LogicalBlockAddress = 0UL; PMI = false; AllocationLength = 0u; Control = 0uy; } : ReadCapacityCDB );
            false, false, false, false, false, ( { OperationCode = 0x9Euy; ServiceAction = 0x10uy; LogicalBlockAddress = 0UL; PMI = false; AllocationLength = 0u; Control = 0uy; } : ReadCapacityCDB );
            ...
            true,  true,  false, true,  true,  ( { OperationCode = 0x3Euy; ServiceAction = 0x00uy; LogicalBlockAddress = 0UL; ByteTransferLength = 0us; CORRT = false; Control = 0uy; } : ReadLongCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x9Euy; ServiceAction = 0x11uy; LogicalBlockAddress = 0UL; ByteTransferLength = 0us; CORRT = false; Control = 0uy; } : ReadLongCDB );
            ...
            true,  true,  false, true,  true,  ( { OperationCode = 0x35uy; SyncNV = false; IMMED = false; LogicalBlockAddress = 0UL; NumberOfBlocks = 0u; GroupNumber = 0uy; Control = 0uy; } : SynchronizeCacheCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x91uy; SyncNV = false; IMMED = false; LogicalBlockAddress = 0UL; NumberOfBlocks = 0u; GroupNumber = 0uy; Control = 0uy; } : SynchronizeCacheCDB );
            false, true,  false, false, true,  ( { OperationCode = 0x2Fuy; VRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; VerificationLength = 0u; Control = 0uy; } : VerifyCDB );
            false, true,  false, false, true,  ( { OperationCode = 0xAFuy; VRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; VerificationLength = 0u; Control = 0uy; } : VerifyCDB );
            false, true,  false, false, true,  ( { OperationCode = 0x8Fuy; VRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; VerificationLength = 0u; Control = 0uy; } : VerifyCDB );
            false, true,  false, false, true,  ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x000Aus; VRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; ExpectedInitialLogicalBlockReferenceTag = 0u; ExpectedLogicalBlockApplicationTag = 0us; LogicalBlockApplicationTagMask = 0us; VerificationLength = 0u; } : Verify32CDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x0Auy; WRPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x2Auy; WRPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0xAAuy; WRPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x8Auy; WRPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x000Bus; WRPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; ExpectedInitialLogicalBlockReferenceTag = 0u; ExpectedLogicalBlockApplicationTag = 0us; LogicalBlockApplicationTagMask = 0us; VerificationLength = 0u; } : Write32CDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x2Euy; WRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteAndVerifyCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0xAEuy; WRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteAndVerifyCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x8Euy; WRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteAndVerifyCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x000Cus; WRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; ExpectedInitialLogicalBlockReferenceTag = 0u; ExpectedLogicalBlockApplicationTag = 0us; LogicalBlockApplicationTagMask = 0us; VerificationLength = 0u; } : WriteAndVerify32CDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x3Fuy; ServiceAction = 0x00uy; LogicalBlockAddress = 0UL; TransferLength = 0us; Control = 0uy; } : WriteLongCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x9Fuy; ServiceAction = 0x11uy; LogicalBlockAddress = 0UL; TransferLength = 0us; Control = 0uy; } : WriteLongCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x41uy; WRPROTECT = 0uy; PBDATA = false; LBDATA = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; NumberOfBlocks = 0u; Control = 0uy; } : WriteSameCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x93uy; WRPROTECT = 0uy; PBDATA = false; LBDATA = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; NumberOfBlocks = 0u; Control = 0uy; } : WriteSameCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x000Dus; WRPROTECT = 0uy; PBDATA = false; LBDATA = false; LogicalBlockAddress = 0UL; ExpectedInitialLogicalBlockReferenceTag = 0u; ExpectedLogicalBlockApplicationTag = 0us; LogicalBlockApplicationTagMask = 0us; VerificationLength = 0u; } : WriteSame32CDB );
            false, true,  false, false, true,  ( { OperationCode = 0x52uy; XORPINFO = false; LogicalBlockAddress = 0u; GroupNumber = 0uy; NumberOfBlocks = 0us; Control = 0uy; } : XDReadCDB );
            false, true,  false, false, true,  ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x0003us; XORPINFO = false; LogicalBlockAddress = 0UL; TransferLength = 0u; } : XDRead32CDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x50uy; WRPROTECT = 0uy; DPO = false; FUA = false; DisableWrite = false; FUA_NV = false; LogicalBlockAddress = 0u; GroupNumber = 0uy; TransferLength = 0us; Control = 0uy; } : XDWriteCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x0004us; WRPROTECT = 0uy; DPO = false; FUA = false; DisableWrite = false; FUA_NV = false; LogicalBlockAddress = 0UL; TransferLength = 0u; } : XDWrite32CDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x53uy; WRPROTECT = 0uy; DPO = false; FUA = false; DisableWrite = false; FUA_NV = false; XORPINFO = false; LogicalBlockAddress = 0u; GroupNumber = 0uy; TransferLength = 0us; Control = 0uy; } : XDWriteReadCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x0007us; WRPROTECT = 0uy; DPO = false; FUA = false; DisableWrite = false; FUA_NV = false; XORPINFO = false; LogicalBlockAddress = 0UL; TransferLength = 0u; } : XDWriteRead32CDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x51uy; DPO = false; FUA = false; FUA_NV = false; XORPINFO = false; LogicalBlockAddress = 0u; GroupNumber = 0uy; TransferLength = 0us; Control = 0uy; } : XPWriteCDB );
            true,  true,  false, true,  true,  ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x0006us; DPO = false; FUA = false; FUA_NV = false; XORPINFO = false; LogicalBlockAddress = 0UL; TransferLength = 0u; } : XPWrite32CDB );
        |]
    ...
    static member m_decideACANoncompliant_001_data = [|
            ...
            [| ( { OperationCode = 0x34uy; IMMED = false; LogicalBlockAddress = 0UL; PrefetchLength = 0u; GroupNumber = 0uy; Control = 0uy; } : PreFetchCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x90uy; IMMED = false; LogicalBlockAddress = 0UL; PrefetchLength = 0u; GroupNumber = 0uy; Control = 0uy; } : PreFetchCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x08uy; RdProtect = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; TransferLength = 0u; GroupNumber = 0uy; Control = 0uy; } : ReadCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x28uy; RdProtect = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; TransferLength = 0u; GroupNumber = 0uy; Control = 0uy; } : ReadCDB ) :> ICDB; |];
            [| ( { OperationCode = 0xA8uy; RdProtect = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; TransferLength = 0u; GroupNumber = 0uy; Control = 0uy; } : ReadCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x88uy; RdProtect = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; TransferLength = 0u; GroupNumber = 0uy; Control = 0uy; } : ReadCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x0009us; RDPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; ExpectedInitialLogicalBlockReferenceTag = 0u; ExpectedLogicalBlockApplicationTag = 0us; LogicalBlockApplicationTagMask = 0us; TransferLength = 0u; } : Read32CDB ) :> ICDB; |];
            [| ( { OperationCode = 0x25uy; ServiceAction = 0x00uy; LogicalBlockAddress = 0UL; PMI = false; AllocationLength = 0u; Control = 0uy; } : ReadCapacityCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x9Euy; ServiceAction = 0x10uy; LogicalBlockAddress = 0UL; PMI = false; AllocationLength = 0u; Control = 0uy; } : ReadCapacityCDB ) :> ICDB; |];
            ...
            [| ( { OperationCode = 0x3Euy; ServiceAction = 0x00uy; LogicalBlockAddress = 0UL; ByteTransferLength = 0us; CORRT = false; Control = 0uy; } : ReadLongCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x9Euy; ServiceAction = 0x11uy; LogicalBlockAddress = 0UL; ByteTransferLength = 0us; CORRT = false; Control = 0uy; } : ReadLongCDB ) :> ICDB; |];
            ...
            [| ( { OperationCode = 0x35uy; SyncNV = false; IMMED = false; LogicalBlockAddress = 0UL; NumberOfBlocks = 0u; GroupNumber = 0uy; Control = 0uy; } : SynchronizeCacheCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x91uy; SyncNV = false; IMMED = false; LogicalBlockAddress = 0UL; NumberOfBlocks = 0u; GroupNumber = 0uy; Control = 0uy; } : SynchronizeCacheCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x2Fuy; VRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; VerificationLength = 0u; Control = 0uy; } : VerifyCDB ) :> ICDB; |];
            [| ( { OperationCode = 0xAFuy; VRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; VerificationLength = 0u; Control = 0uy; } : VerifyCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x8Fuy; VRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; VerificationLength = 0u; Control = 0uy; } : VerifyCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x000Aus; VRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; ExpectedInitialLogicalBlockReferenceTag = 0u; ExpectedLogicalBlockApplicationTag = 0us; LogicalBlockApplicationTagMask = 0us; VerificationLength = 0u; } : Verify32CDB ) :> ICDB; |];
            [| ( { OperationCode = 0x0Auy; WRPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x2Auy; WRPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteCDB ) :> ICDB; |];
            [| ( { OperationCode = 0xAAuy; WRPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x8Auy; WRPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x000Bus; WRPROTECT = 0uy; DPO = false; FUA = false; FUA_NV = false; LogicalBlockAddress = 0UL; ExpectedInitialLogicalBlockReferenceTag = 0u; ExpectedLogicalBlockApplicationTag = 0us; LogicalBlockApplicationTagMask = 0us; VerificationLength = 0u; } : Write32CDB ) :> ICDB; |];
            [| ( { OperationCode = 0x2Euy; WRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteAndVerifyCDB ) :> ICDB; |];
            [| ( { OperationCode = 0xAEuy; WRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteAndVerifyCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x8Euy; WRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; TransferLength = 0u; Control = 0uy; } : WriteAndVerifyCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x000Cus; WRPROTECT = 0uy; DPO = false; BYTCHK = false; LogicalBlockAddress = 0UL; ExpectedInitialLogicalBlockReferenceTag = 0u; ExpectedLogicalBlockApplicationTag = 0us; LogicalBlockApplicationTagMask = 0us; VerificationLength = 0u; } : WriteAndVerify32CDB ) :> ICDB; |];
            [| ( { OperationCode = 0x3Fuy; ServiceAction = 0x00uy; LogicalBlockAddress = 0UL; TransferLength = 0us; Control = 0uy; } : WriteLongCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x9Fuy; ServiceAction = 0x11uy; LogicalBlockAddress = 0UL; TransferLength = 0us; Control = 0uy; } : WriteLongCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x41uy; WRPROTECT = 0uy; PBDATA = false; LBDATA = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; NumberOfBlocks = 0u; Control = 0uy; } : WriteSameCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x93uy; WRPROTECT = 0uy; PBDATA = false; LBDATA = false; LogicalBlockAddress = 0UL; GroupNumber = 0uy; NumberOfBlocks = 0u; Control = 0uy; } : WriteSameCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x000Dus; WRPROTECT = 0uy; PBDATA = false; LBDATA = false; LogicalBlockAddress = 0UL; ExpectedInitialLogicalBlockReferenceTag = 0u; ExpectedLogicalBlockApplicationTag = 0us; LogicalBlockApplicationTagMask = 0us; VerificationLength = 0u; } : WriteSame32CDB ) :> ICDB; |];
            [| ( { OperationCode = 0x52uy; XORPINFO = false; LogicalBlockAddress = 0u; GroupNumber = 0uy; NumberOfBlocks = 0us; Control = 0uy; } : XDReadCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x0003us; XORPINFO = false; LogicalBlockAddress = 0UL; TransferLength = 0u; } : XDRead32CDB ) :> ICDB; |];
            [| ( { OperationCode = 0x50uy; WRPROTECT = 0uy; DPO = false; FUA = false; DisableWrite = false; FUA_NV = false; LogicalBlockAddress = 0u; GroupNumber = 0uy; TransferLength = 0us; Control = 0uy; } : XDWriteCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x0004us; WRPROTECT = 0uy; DPO = false; FUA = false; DisableWrite = false; FUA_NV = false; LogicalBlockAddress = 0UL; TransferLength = 0u; } : XDWrite32CDB ) :> ICDB; |];
            [| ( { OperationCode = 0x53uy; WRPROTECT = 0uy; DPO = false; FUA = false; DisableWrite = false; FUA_NV = false; XORPINFO = false; LogicalBlockAddress = 0u; GroupNumber = 0uy; TransferLength = 0us; Control = 0uy; } : XDWriteReadCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x0007us; WRPROTECT = 0uy; DPO = false; FUA = false; DisableWrite = false; FUA_NV = false; XORPINFO = false; LogicalBlockAddress = 0UL; TransferLength = 0u; } : XDWriteRead32CDB ) :> ICDB; |];
            [| ( { OperationCode = 0x51uy; DPO = false; FUA = false; FUA_NV = false; XORPINFO = false; LogicalBlockAddress = 0u; GroupNumber = 0uy; TransferLength = 0us; Control = 0uy; } : XPWriteCDB ) :> ICDB; |];
            [| ( { OperationCode = 0x7Fuy; Control = 0uy; GroupNumber = 0uy; AdditionalCDBLength = 18uy; ServiceAction = 0x0006us; DPO = false; FUA = false; FUA_NV = false; XORPINFO = false; LogicalBlockAddress = 0UL; TransferLength = 0u; } : XPWrite32CDB ) :> ICDB; |];
        |]
