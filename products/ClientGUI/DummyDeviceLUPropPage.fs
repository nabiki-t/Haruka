...
// DummyDeviceLUPropPage.fs : Implement the function to display Dummy Device LU property page in the main window.
//
...
type DummyDeviceLUPropPage(
    ...
    do
        ...
        m_Config.SetLocalizedText "DummyDeviceLUPropPage" m_PropPage
        ...
        m_StatusExpander.Expanded.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "DummyDeviceLUPropPage" m_StatusExpander.Name true )
        m_StatusExpander.Collapsed.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "DummyDeviceLUPropPage" m_StatusExpander.Name false )
        m_ConfigurationExpander.Expanded.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "DummyDeviceLUPropPage" m_ConfigurationExpander.Name true )
        m_ConfigurationExpander.Collapsed.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "DummyDeviceLUPropPage" m_ConfigurationExpander.Name false )
        ...
        // Set default value
        m_StatusExpander.IsExpanded <- UserOpeStat.GetExpanded "DummyDeviceLUPropPage" m_StatusExpander.Name
        m_ConfigurationExpander.IsExpanded <- UserOpeStat.GetExpanded "DummyDeviceLUPropPage" m_ConfigurationExpander.Name
