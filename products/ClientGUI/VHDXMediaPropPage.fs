...
// VHDXMediaPropPage.fs : Implement the function to display VHDX Media property page in the main window.
//
...
type VHDXMediaPropPage(
    ...
    do
        ...
        m_Config.SetLocalizedText "VHDXMediaPropPage" m_PropPage
        ...
        m_UsageExpander.Expanded.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "VHDXMediaPropPage" m_UsageExpander.Name true )
        m_UsageExpander.Collapsed.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "VHDXMediaPropPage" m_UsageExpander.Name false )
        m_ConfigurationExpander.Expanded.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "VHDXMediaPropPage" m_ConfigurationExpander.Name true )
        m_ConfigurationExpander.Collapsed.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "VHDXMediaPropPage" m_ConfigurationExpander.Name false )
        ...
        // Set default value
        m_UsageExpander.IsExpanded <- UserOpeStat.GetExpanded "VHDXMediaPropPage" m_UsageExpander.Name
        m_ConfigurationExpander.IsExpanded <- UserOpeStat.GetExpanded "VHDXMediaPropPage" m_ConfigurationExpander.Name
    ...
    member private this.OnClick_ApplyButton() : unit = 
        try
            let mn = m_ServerStatus.GetNode m_NodeID :?> ConfNode_VHDXMedia
            ...
            let newNode = m_ServerStatus.UpdateVHDXMediaNode mn conf
            this.ShowConfigValue false false
