...
type HLogger() =
    ...
    static let m_Messages =
        seq { 
            ...
            ( LogID.I_FAILED_GET_CONFFILE_IN_REG,       "Failed to retrieve configuration file name from registry. KeyName={0}, message={0}" )
            ...
            ( LogID.E_TASK_IRREGAL_TERMINATED,          "SCSI task was illegally terminated. Status={0}, msg={0}" )
