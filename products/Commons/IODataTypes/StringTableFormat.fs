...
<xsd:schema xmlns:xsd='http://www.w3.org/2001/XMLSchema'>
  <xsd:element name='Messages' >
    ...
    /// </returns>
    static member private T_Messages_toString ( indent : int32 ) ( indentStep : int32 ) ( elem : T_Messages ) ( elemName : string ) : seq<string> = 
    ...
    ///  Array of the generated string.
    /// </returns>
    static member private T_Section_toString ( indent : int32 ) ( indentStep : int32 ) ( elem : T_Section ) ( elemName : string ) : seq<string> = 
        let indentStr = String.replicate ( indent * indentStep ) " "
        let singleIndent = String.replicate ( indentStep ) " "
        seq {
            yield sprintf "%s<%s>" indentStr elemName
    ...
    ///  Array of the generated string.
    /// </returns>
    static member private T_Message_toString ( indent : int32 ) ( indentStep : int32 ) ( elem : T_Message ) ( elemName : string ) : seq<string> = 
        let indentStr = String.replicate ( indent * indentStep ) " "
        let singleIndent = String.replicate ( indentStep ) " "
        seq {
            yield sprintf "%s<%s>" indentStr elemName
