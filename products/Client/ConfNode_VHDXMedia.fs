...
// ConfNode_VHDXMedia.fs : It represents configurations of VHDX file media.
//
...
/// </param>
type ConfNode_VHDXMedia(
        m_MessageTable : StringTable,
        m_ConfNodes : ConfNodeRelation,
        m_NodeID : CONFNODE_T,
        m_Value : TargetGroupConf.T_VHDXFile
    ) =
    ...
    new ( argMessageTable : StringTable, argConfNodes : ConfNodeRelation, newNodeID : CONFNODE_T, tempExp : TempExport.T_Node ) =
        ...
        new ConfNode_VHDXMedia( argMessageTable, argConfNodes, newNodeID, conf )
    ...
    interface IMediaNode with
        ...
        override _.NodeTypeName : string =
            ClientConst.NODE_TYPE_NAME_VHDXMedia
        ...
        override _.SortKey =
            [
                ClientConst.SORT_KEY_TYPE_VHDXMedia;
                m_Value.MediaName;
        ...
        override _.TempExportData : TempExport.T_Node =
            {
                TypeName = ClientConst.TEMPEXP_NN_VHDXMedia;
        ...
        override  _.MediaConfData : TargetGroupConf.T_MEDIA =
            TargetGroupConf.T_MEDIA.U_VHDXFile( m_Value )
    ...
    member _.CreateUpdatedNode 
        ( argValue : TargetGroupConf.T_VHDXFile ) : ConfNode_VHDXMedia =
        new ConfNode_VHDXMedia( m_MessageTable, m_ConfNodes, m_NodeID, argValue )
