...
type ServerStatusStub( m_MessageTable : StringTable ) =
    ...
    let mutable m_AddBlockDeviceLUNode : ( ConfNode_Target -> LUN_T -> string -> uint32 ->  BLKCNT32_T -> ConfNode_BlockDeviceLU ) option = None
    let mutable m_UpdateBlockDeviceLUNode : ( ConfNode_BlockDeviceLU -> LUN_T -> string -> uint32 -> BLKCNT32_T -> ConfNode_BlockDeviceLU ) option = None
    ...
    override _.AddBlockDeviceLUNode tnode argLUN argLUName argMaxMultiplicity argOptimalTransferLength = m_AddBlockDeviceLUNode.Value tnode argLUN argLUName argMaxMultiplicity argOptimalTransferLength
    override _.UpdateBlockDeviceLUNode lunode argLUN argLUName argMaxMultiplicity argOptimalTransferLength = m_UpdateBlockDeviceLUNode.Value lunode argLUN argLUName argMaxMultiplicity argOptimalTransferLength
...
type CommandRunner_Test1() =
    ...
    static member m_BlockDeviceLUNode =
        ...
        let n = new ConfNode_BlockDeviceLU( new StringTable( "" ), cnr, confnode_me.fromPrim 0UL, lun_me.zero, "", mult, otl ) :> IConfigureNode
        cnr.AddNode n
        n
