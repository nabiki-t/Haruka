...
type PDU_Test () =
    ...
    member _.SCSICommandPDU_007() =
        ...
        let buf : byte[] =
            [|
                ...
                0x00uy; 0x00uy; 0x00uy; 0x00uy; // Header digest
            |]
        ByteFunc.WriteU32BE buf 68u ( Crc32C.Compute buf.[0..67] )
        ms.Write( buf, 0, buf.Length )
        ms.Seek( 0L, SeekOrigin .Begin ) |> ignore
    ...
    member _.SCSICommandPDU_009() =
        ...
        let buf : byte[] =
            [|
                ...
                0x00uy; 0x00uy; 0x00uy; 0x00uy; // Header digest
            |]
        ByteFunc.WriteU32BE buf 60u ( Crc32C.Compute buf.[0..59] )
        ms.Write( buf, 0, buf.Length )
        ms.Seek( 0L, SeekOrigin .Begin ) |> ignore
    ...
    member _.SCSICommandPDU_017() =
        ...
        let buf : byte[] =
            ...
            |]
        ByteFunc.WriteU32BE buf 68u ( Crc32C.Compute buf.[0..67] )
        ByteFunc.WriteU32BE buf 80u ( Crc32C.Compute buf.[72..79] )
        ms.Write( buf, 0, buf.Length )
        ms.Seek( 0L, SeekOrigin .Begin ) |> ignore
    ...
    member _.SCSICommandPDU_022() =
        ...
        let buf : byte[] =
            ...
            |]
        ByteFunc.WriteU32BE buf 60u ( Crc32C.Compute buf.[0..59] )
        ByteFunc.WriteU32BE buf 72u ( Crc32C.Compute buf.[64..71] )
        ms.Write( buf, 0, buf.Length )
        ms.Seek( 0L, SeekOrigin .Begin ) |> ignore
    ...
    member _.SCSIResponsePDU_001() =
        ...
        let buf =
            ...
            |]
        ByteFunc.WriteU32BE buf 68u ( Crc32C.Compute buf.[0..67] )
        ByteFunc.WriteU32BE buf 76u ( Crc32C.Compute buf.[72..75] )
        ms.Write( buf, 0, buf.Length )
        ms.Seek( 0L, SeekOrigin .Begin ) |> ignore
    ...
    member _.TaskManagementFunctionRequestPDU_002() =
        ...
        let buf =
             [|
                ...
                0xAAuy; 0x00uy; 0x00uy; 0x00uy  // Data Digest
            |]
        ByteFunc.WriteU32BE buf 48u ( Crc32C.Compute buf.[0..47] )
        ByteFunc.WriteU32BE buf 56u ( Crc32C.Compute buf.[52..55] )
        ms.Write( buf, 0, buf.Length )
        ms.Seek( 0L, SeekOrigin .Begin ) |> ignore
