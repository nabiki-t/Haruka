...
type CommandParser_Test1() =
    ...
    member _.DiviteInputString_001() =
        ...
        let r = CommandParser.FromString accCommands "exit 123"
    ...
    member _.DiviteInputString_002() =
        ...
        let r = CommandParser.FromString accCommands "exit /n a^ a"
        Assert.True(( r.Varb = testVerb.Exit ))
    ...
    member _.DiviteInputString_004() =
        let accCommands = exitAccCmd [| ( "/n", CRV_String( 256 ) ) |] Array.empty Array.empty
        let r = CommandParser.FromString accCommands "exit /n abb^"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 1 ))
    ...
    member _.SearchCommand_001() =
        ...
        |]
        let r = CommandParser.FromString accCommands "aa1"
        Assert.True(( r.Varb = testVerb.Exit ))
    ...
    member _.SearchCommand_002() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands "aa1 a" |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.UnknownCommand( "aa1" ), e.ErrorCode )
    ...
    member _.SearchCommand_003() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands "aa1 bb1" |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.UnknownCommand( "aa1" ), e.ErrorCode )
    ...
    member _.SearchCommand_004() =
        ...
        |]
        let r = CommandParser.FromString accCommands "aa"
    ...
    member _.SearchCommand_005() =
        ...
        |]
        let r = CommandParser.FromString accCommands "aa bb"
        Assert.True(( r.Varb = testVerb.Logout ))
    ...
    member _.SearchCommand_006() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands "aa1" |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.UnknownCommand( "aa1" ), e.ErrorCode )
    ...
    member _.SearchCommand_008() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands "aa" |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.UnknownCommand( "aa" ), e.ErrorCode )
    ...
    member _.SearchCommand_013() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands "aa1 cc1" |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.UnknownCommand( "aa1" ), e.ErrorCode )
    ...
    member _.SearchCommand_016() =
        ...
        |]
        let r = CommandParser.FromString accCommands "aa1 cc1"
    ...
    member _.SearchCommand_017() =
        ...
        |]
        let r = CommandParser.FromString accCommands "aa1 cc1 dd"
        Assert.True(( r.Varb = testVerb.Login ))
    ...
    member _.SearchCommand_019() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands "aa dd" |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.UnknownCommand( "aa" ), e.ErrorCode )
    ...
    member _.SearchCommand_020() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands "aa bb" |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.UnknownCommand( "aa" ), e.ErrorCode )
    ...
    member _.SearchCommand_023() =
        let accCommands = [|
            ...
            genAccCmd2 [| "AA1"; "CC1"; |] testVerb.Login Array.empty;
        |]
        let r = CommandParser.FromString accCommands "aa bb dd"
        Assert.True(( r.Varb = testVerb.Exit ))
    ...
    member _.SearchCommand_030() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands "aa bb cc" |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.InvalidArgCount, e.ErrorCode )
    ...
    member _.SearchCommand_031() =
        let accCommands = [|
            genAccCmd2 [| "AA1"; "BB1" |] testVerb.Exit [| CRV_String( 2 ) |];
        |]
        let r = CommandParser.FromString accCommands "aa bb cc"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamelessArgs.Length = 1 ))
    ...
    member _.RecognizeCommand_001() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromStringArray accCommands Array.empty |> ignore
            )
    ...
    member _.RecognizeCommand_002() =
        let accCommands = exitAccCmd Array.empty [| "/y" |] Array.empty
        let r = CommandParser.FromString accCommands "eXIt"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 0 ))
        Assert.True(( r.NamelessArgs.Length = 0 ))
    ...
    member _.RecognizeCommand_003() =
        let accCommands = exitAccCmd Array.empty [| "/y" |] Array.empty
        let r = CommandParser.FromString accCommands "exit /y"
        Assert.True(( r.Varb = testVerb.Exit ))
    ...
    member _.RecognizeCommand_004() =
        ...
        let r = CommandParser.FromString accCommands "exit /y 1"
        Assert.True(( r.Varb = testVerb.Exit ))
    ...
    member _.RecognizeCommand_005() =
        ...
        let r = CommandParser.FromString accCommands "exit aaa"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 0 ))
        Assert.True(( r.NamelessArgs.Length = 1 ))
    ...
    member _.RecognizeCommand_006() =
        ...
        let r = CommandParser.FromString accCommands "exit /a 0 /b 1"
        Assert.True(( r.Varb = testVerb.Exit ))
    ...
    member _.RecognizeCommand_007() =
        ...
        let r = CommandParser.FromString accCommands "exit /a 0 /b"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 2 ))
        Assert.True(( r.NamedArgs.[ "/a" ] = EV_int32( 0 ) ))
    ...
    member _.RecognizeCommand_008() =
        ...
        let r = CommandParser.FromString accCommands "exit /a 0 1"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 1 ))
        Assert.True(( r.NamedArgs.[ "/a" ] = EV_int32( 0 ) ))
        Assert.True(( r.NamelessArgs.Length = 1 ))
    ...
    member _.RecognizeCommand_009() =
        let accCommands = exitAccCmd [| ( "/a", CRV_int32( 0, 1 ) ); |] [| "/b" |] Array.empty
        let r = CommandParser.FromString accCommands "exit /b /a 0"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 2 ))
        Assert.True(( r.NamedArgs.[ "/a" ] = EV_int32( 0 ) ))
        Assert.True(( r.NamedArgs.[ "/b" ] = EV_NoValue ))
    ...
    member _.RecognizeCommand_010() =
        ...
        let r = CommandParser.FromString accCommands "exit /c /b"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 2 ))
        Assert.True(( r.NamedArgs.[ "/b" ] = EV_NoValue ))
    ...
    member _.RecognizeCommand_011() =
        ...
        let r = CommandParser.FromString accCommands "exit /b 0"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 1 ))
        Assert.True(( r.NamedArgs.[ "/b" ] = EV_NoValue ))
        Assert.True(( r.NamelessArgs.Length = 1 ))
    ...
    member _.RecognizeCommand_012() =
        let accCommands = exitAccCmd [| ( "/a", CRV_int32( 0, 1 ) ); |] Array.empty [| CRV_int32( 0, 1 ) |]
        let r = CommandParser.FromString accCommands "exit 0 /a 1"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 1 ))
    ...
    member _.RecognizeCommand_013() =
        let accCommands = exitAccCmd Array.empty [| "/b" |] [| CRV_int32( 0, 1 ) |]
        let r = CommandParser.FromString accCommands "exit 0 /b"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 1 ))
        Assert.True(( r.NamedArgs.[ "/b" ] = EV_NoValue ))
        Assert.True(( r.NamelessArgs.Length = 1 ))
    ...
    member _.RecognizeCommand_014() =
        ...
        let r = CommandParser.FromString accCommands "exit 0 1"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 0 ))
    ...
    member _.RecognizeCommand_015() =
        ...
        let r = CommandParser.FromString accCommands "exit /b aaa /c 0 /a 1"
        Assert.True(( r.Varb = testVerb.Exit ))
    ...
    member _.RecognizeCommand_016() =
        ...
        let r = CommandParser.FromString accCommands "exit /c /a /b"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 3 ))
    ...
    member _.RecognizeCommand_017() =
        ...
        let r = CommandParser.FromString accCommands "exit 1 aaa bbb"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 0 ))
    ...
    member _.RecognizeCommand_018() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands "exit /a" |> ignore
            )
    ...
    member _.RecognizeCommand_019 ( cmd : string ) =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands cmd |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.InvalidArgCount, e.ErrorCode )
    ...
    member _.RecognizeCommand_020 ( cmd : string ) =
        let accCommands = exitAccCmd Array.empty Array.empty [| CRVM_String( 10 ); CRVM_String( 10 ); CRV_String( 10 ); CRV_String( 10 ); |]
        let r = CommandParser.FromString accCommands cmd
        Assert.True(( r.Varb = testVerb.Exit ))
    ...
    member _.RecognizeCommand_022() =
        let accCommands = exitAccCmd [| ( "/a", CRV_int32( 0, 1 ) ); |] Array.empty Array.empty
        let r = CommandParser.FromString accCommands "exit /a 0 /a 1"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 1 ))
        Assert.True(( r.NamedArgs.[ "/a" ] = EV_int32 1 ))
        Assert.True(( r.NamelessArgs.Length = 0 ))
    ...
    member _.RecognizeCommand_023() =
        let accCommands = exitAccCmd Array.empty [| "/y" |] Array.empty
        let r = CommandParser.FromString accCommands "exit /y /y /y"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 1 ))
        Assert.True(( r.NamedArgs.[ "/y" ] = EV_NoValue ))
        Assert.True(( r.NamelessArgs.Length = 0 ))
    ...
    member _.RecognizeCommand_024() =
        ...
        let r = CommandParser.FromString accCommands "exit /a aaa /y /a bbb /y"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 2 ))
    ...
    member _.RecognizeCommand_025() =
        ...
        let r = CommandParser.FromString accCommands "exit /a 1"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 1 ))
        Assert.True(( r.NamedArgs.[ "/a" ] = EV_int32( 1 ) ))
        Assert.True(( r.NamelessArgs.Length = 0 ))
    ...
    member _.RecognizeCommand_026() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands "exit" |> ignore
            )
    ...
    member _.RecognizeCommand_033() =
        ...
        let r = CommandParser.FromString accCommands "exit /a a"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 1 ))
    ...
    member _.RecognizeCommand_037() =
        ...
        let r = CommandParser.FromString accCommands "exit /a 0"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 1 ))
    ...
    [<Theory>]
    [<InlineData( "exit /a aaa", "aaa" )>]
    [<InlineData( "exit /a 1.1", "1.1" )>]
    [<InlineData( "exit /a -2147483649", "-2147483649" )>]
    [<InlineData( "exit /a -2147483648", "-2147483648" )>]
    [<InlineData( "exit /a -101", "-101" )>]
    [<InlineData( "exit /a 101", "101" )>]
    [<InlineData( "exit /a 2147483648", "2147483648" )>]
    [<InlineData( "exit /a 2147483647", "2147483647" )>]
    member _.ValidateValue_int32_001( ecmd : string ) ( errval : string ) =
        let accCommands = exitAccCmd [| ( "/a", CRV_int32( -100, 100 ) ); |] Array.empty Array.empty
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands ecmd |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.InvalidArgValue( errval ), e.ErrorCode )
    ...
    [<InlineData( "exit /a 2147483648", "2147483648" )>]
    [<InlineData( "exit /a 2147483647", "2147483647" )>]
    member _.ValidateValue_int32_m_001( ecmd : string ) ( errval : string ) =
    ...
    [<InlineData( "exit /a 0", "0" )>]
    [<InlineData( "exit /a 9", "9" )>]
    [<InlineData( "exit /a 101", "101" )>]
    [<InlineData( "exit /a 4294967295", "4294967295" )>]
    [<InlineData( "exit /a 4294967296", "4294967296" )>]
    member _.ValidateValue_uint32_001( ecmd : string ) ( errval : string ) =
    ...
    [<InlineData( "exit /a 4294967295", "4294967295" )>]
    [<InlineData( "exit /a 4294967296", "4294967296" )>]
    member _.ValidateValue_uint32_m_001( ecmd : string ) ( errval : string ) =
    ...
    [<InlineData( "exit /a aaa", "aaa" )>]
    [<InlineData( "exit /a 1.1", "1.1" )>]
    [<InlineData( "exit /a -9223372036854775809", "-9223372036854775809" )>]
    [<InlineData( "exit /a -9223372036854775808", "-9223372036854775808" )>]
    [<InlineData( "exit /a 9", "9" )>]
    [<InlineData( "exit /a 101", "101" )>]
    [<InlineData( "exit /a 9223372036854775807", "9223372036854775807" )>]
    [<InlineData( "exit /a 9223372036854775808", "9223372036854775808" )>]
    member _.ValidateValue_int64_001( ecmd : string ) ( errval : string ) =
    ...
    [<InlineData( "exit /a 9223372036854775807", "9223372036854775807" )>]
    [<InlineData( "exit /a 9223372036854775808", "9223372036854775808" )>]
    member _.ValidateValue_int64_m_001( ecmd : string ) ( errval : string ) =
    ...
    [<InlineData( "exit /a 9", "9" )>]
    [<InlineData( "exit /a 101", "101" )>]
    [<InlineData( "exit /a 18446744073709551615", "18446744073709551615" )>]
    [<InlineData( "exit /a 18446744073709551616", "18446744073709551616" )>]
    member _.ValidateValue_uint64_001( ecmd : string ) ( errval : string ) =
    ...
    [<InlineData( "exit /a 18446744073709551615", "18446744073709551615" )>]
    [<InlineData( "exit /a 18446744073709551616", "18446744073709551616" )>]
    member _.ValidateValue_uint64_m_001( ecmd : string ) ( errval : string ) =
    ...
    [<Theory>]
    [<InlineData( "exit /a 123456", "123456" )>]
    [<InlineData( "exit /a 123^ 56", "123 56" )>]
    [<InlineData( "exit /a 123^^56", "123^56" )>]
    member _.ValidateValue_String_001( ecmd : string ) ( errval : string ) =
    ...
    [<InlineData( "exit /a 123^ 56", "123 56" )>]
    [<InlineData( "exit /a 123^^56", "123^56" )>]
    member _.ValidateValue_String_m_001( ecmd : string ) ( errval : string ) =
    ...
    member _.ValidateValue_Regex_001() =
        ...
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands "exit /a cd" |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.InvalidArgValue( "cd" ), e.ErrorCode )

    [<Fact>]
    member _.ValidateValue_Regex_002() =
        let accCommands = exitAccCmd [| ( "/a", CRV_Regex( new Regex "aaa.*bbb" ) ); |] Array.empty Array.empty
        let r = CommandParser.FromString accCommands "exit /a aaaXXbbb"
        Assert.True(( r.Varb = testVerb.Exit ))
        Assert.True(( r.NamedArgs.Count = 1 ))
    ...
    [<Theory>]
    [<InlineData( "exit /a a", "a" )>]
    [<InlineData( "exit /a 0a00", "0a00" )>]
    [<InlineData( "exit /a 00-11", "00-11" )>]
    [<InlineData( "exit /a -1", "-1" )>]
    [<InlineData( "exit /a 18446744073709551616", "18446744073709551616" )>]
    [<InlineData( "exit /a 0x10000000000000000", "0x10000000000000000" )>]
    member _.ValidateValue_LUN_001( ecmd : string ) ( errval : string ) =
    ...
    [<InlineData( "exit /a 18446744073709551616", "18446744073709551616" )>]
    [<InlineData( "exit /a 0x10000000000000000", "0x10000000000000000" )>]
    member _.ValidateValue_LUN_m_001( ecmd : string ) ( errval : string ) =
        let accCommands = exitAccCmd [| ( "/a", CRVM_LUN ); |] Array.empty Array.empty
        let e =
            Assert.Throws< CommandInputError >( fun () ->
                CommandParser.FromString accCommands ecmd |> ignore
    ...
    member _.DefaultNamedInt32_003() =
        let accCommands = exitAccCmd [| ( "/a", CRV_String( 5 ) ); |] Array.empty Array.empty
        let r = CommandParser.FromString accCommands "exit /a aaa"
        Assert.True(( ( r.DefaultNamedInt32 "/b" 99 ) = 99 ))
    ...
    member _.DefaultNamedUInt32_003() =
        let accCommands = exitAccCmd [| ( "/a", CRV_String( 5 ) ); |] Array.empty Array.empty
        let r = CommandParser.FromString accCommands "exit /a bbb"
        Assert.True(( ( r.DefaultNamedUInt32 "/b" 99u ) = 99u ))
    ...
    member _.DefaultNamedString_003() =
        ...
        let r = CommandParser.FromString accCommands "exit /a 12"
        Assert.True(( ( r.DefaultNamedString "/b" "bbb" ) = "bbb" ))
    ...
    member _.NamedString_003() =
        let accCommands = exitAccCmd [| ( "/a", CRV_int32( 10, 15 ) ); |] Array.empty Array.empty
        let r = CommandParser.FromString accCommands "exit /a 14"
        Assert.True(( ( r.NamedString "/b" ) = None ))
    ...
    member _.DefaultNamelessInt32_001() =
        ...
        let r = CommandParser.FromString accCommands "exit 1"
    ...
    member _.ValidateNamelessValues_001() =
        ...
        let r = CommandParser.FromString accCommands "exit aa bb"
        Assert.True(( r.NamelessArgs.Length = 4 ))
    ...
    member _.ValidateNamelessValues_003() =
        ...
        let x =
            Assert.Throws<CommandInputError>( fun () ->
                CommandParser.FromString accCommands "exit aa bb cc" |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.NamelessPatternMismatch, x.ErrorCode )

    [<Fact>]
    member _.ValidateNamelessValues_004() =
        let accCommands = exitAccCmd Array.empty Array.empty [| CRVM_String( 5 ); CRV_int32( 0, 1 ); CRV_int32( 0, 1 ); CRVM_String( 5 ); |]
        let r = CommandParser.FromString accCommands "exit aa 1 bb"
        Assert.True(( r.NamelessArgs.Length = 4 ))
        Assert.True(( r.NamelessArgs.[0] = EV_String( "aa" ) ))
    ...
    member _.ValidateNamelessValues_005() =
        ...
        let x =
            Assert.Throws<CommandInputError>( fun () ->
                CommandParser.FromString accCommands "exit aa bb" |> ignore
            )
        Assert.StrictEqual( CIE_ErrorCode.NamelessPatternMismatch, x.ErrorCode )
