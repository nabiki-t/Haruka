...
namespace Haruka.Test.UT.ConfRW_003_013
...
<xsd:schema xmlns:xsd='http://www.w3.org/2001/XMLSchema'>
  <xsd:element name='Test' >
    <xsd:complexType><xsd:sequence>
      ...
      <xsd:element name='D2' type='T031_1' ></xsd:element>
    </xsd:sequence></xsd:complexType>
  </xsd:element>
  <xsd:complexType name='T031_1'>
    <xsd:sequence>
      <xsd:element name='D3' >
        <xsd:simpleType>
          <xsd:restriction base='xsd:int'>
      ...
      <xsd:element name='R031_1' >
        <xsd:complexType><xsd:choice>
          ...
          <xsd:element name='D5' type='T031_1' ></xsd:element>
    ...
    static member private Read_T_Test ( elem : XElement ) : T_Test = 
        {
            ...
            D2 =
                ReaderWriter.Read_T_T031_1( elem.Element( XName.Get "D2" ) );
        }

    /// <summary>
    ///  Read T_T031_1 data from XML document.
    /// </summary>
    /// <param name="elem">
    ///  Loaded XML document.
    /// </param>
    /// <returns>
    ///  parsed T_T031_1 data structure.
    /// </returns>
    static member private Read_T_T031_1 ( elem : XElement ) : T_T031_1 = 
        {
            D3 =
                Int32.Parse( elem.Element( XName.Get "D3" ).Value );
            R031_1 =
                ReaderWriter.Read_T_R031_1( elem.Element( XName.Get "R031_1" ) );
        }

    /// <summary>
    ///  Read T_R031_1 data from XML document.
    /// </summary>
    /// <param name="elem">
    ///  Loaded XML document.
    /// </param>
    /// <returns>
    ///  parsed T_R031_1 data structure.
    /// </returns>
    static member private Read_T_R031_1 ( elem : XElement ) : T_R031_1 = 
        let firstChild = elem.Elements() |> Seq.head 
        let firstChildName = firstChild.Name
        match firstChildName.LocalName with
        | "D4" ->
            U_D4( Int32.Parse( firstChild.Value ) )
        | "D5" ->
            U_D5( ReaderWriter.Read_T_T031_1( firstChild ) )
    ...
    static member private T_Test_toString ( indent : int ) ( indentStep : int ) ( elem : T_Test ) ( elemName : string ) : seq<string> = 
        ...
        seq {
            ...
            yield! ReaderWriter.T_T031_1_toString ( indent + 1 ) indentStep ( elem.D2 ) "D2"
            yield sprintf "%s</%s>" indentStr elemName
        }

    /// <summary>
    ///  Write T_T031_1 data structure to configuration file.
    /// </summary>
    /// <param name="indent">
    ///  Indent space count.
    /// </param>
    ...
    static member private T_T031_1_toString ( indent : int ) ( indentStep : int ) ( elem : T_T031_1 ) ( elemName : string ) : seq<string> = 
        ...
        seq {
            ...
            yield! ReaderWriter.T_R031_1_toString ( indent + 1 ) indentStep ( elem.R031_1 ) "R031_1"
            yield sprintf "%s</%s>" indentStr elemName
        }

    /// <summary>
    ///  Write T_R031_1 data structure to configuration file.
    /// </summary>
    /// <param name="indent">
    ///  Indent space count.
    /// </param>
    ...
    static member private T_R031_1_toString ( indent : int ) ( indentStep : int ) ( elem : T_R031_1 ) ( elemName : string ) : seq<string> = 
        ...
        seq {
            ...
            match elem with
            | U_D4( x ) ->
                yield sprintf "%s%s<D4>%d</D4>" singleIndent indentStr (x)
            | U_D5( x ) ->
                yield! ReaderWriter.T_T031_1_toString ( indent + 1 ) indentStep ( x ) "D5"
            yield sprintf "%s</%s>" indentStr elemName
        }
