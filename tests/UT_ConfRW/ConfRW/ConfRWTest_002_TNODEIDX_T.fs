...
// Definition of ConfRW_UT002_TNODEIDX_T configuration reader/writer function.

//=============================================================================
// Namespace declaration

namespace Haruka.Test.UT.ConfRW_002_TNODEIDX_T
...
///  ConfRW_UT002_TNODEIDX_T class imprements read and write function of configuration.
type ConfRW_UT002_TNODEIDX_T() =
...
<xsd:schema xmlns:xsd='http://www.w3.org/2001/XMLSchema'>
  <xsd:element name='Test' >
    ...
    static member LoadFile ( fname : string ) : T_Test =
        fname |> File.ReadAllText |> ConfRW_UT002_TNODEIDX_T.LoadString
    ...
    static member LoadString ( s : string ) : T_Test =
        ...
        "Test" |> xdoc.Element |> ConfRW_UT002_TNODEIDX_T.Read_T_Test
    ...
    static member WriteFile ( fname : string ) ( d : T_Test ) : unit =
        let s = ConfRW_UT002_TNODEIDX_T.T_Test_toString 0 2 d "Test"
    ...
    static member ToString ( d : T_Test ) : string =
        ConfRW_UT002_TNODEIDX_T.T_Test_toString 0 0 d "Test"
        |> String.Concat
