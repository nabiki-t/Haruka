...
namespace Haruka.Test.UT.ConfRW_003_010
...
<xsd:schema xmlns:xsd='http://www.w3.org/2001/XMLSchema'>
  <xsd:element name='Test' >
    ...
    static member private Read_T_Test ( elem : XElement ) : T_Test = 
        {
            R028_1 =
                ReaderWriter.Read_T_R028_1( elem.Element( XName.Get "R028_1" ) );
        }

    /// <summary>
    ///  Read T_R028_1 data from XML document.
    /// </summary>
    /// <param name="elem">
    ///  Loaded XML document.
    /// </param>
    /// <returns>
    ///  parsed T_R028_1 data structure.
    /// </returns>
    static member private Read_T_R028_1 ( elem : XElement ) : T_R028_1 = 
        ...
        | "R028_2" ->
            U_R028_2( ReaderWriter.Read_T_R028_2 firstChild )
        | "D2" ->
            U_D2( Int32.Parse( firstChild.Value ) )
        | _ -> raise <| ConfRWException( "Unexpected tag name." )

    /// <summary>
    ///  Read T_R028_2 data from XML document.
    /// </summary>
    /// <param name="elem">
    ///  Loaded XML document.
    /// </param>
    /// <returns>
    ///  parsed T_R028_2 data structure.
    /// </returns>
    static member private Read_T_R028_2 ( elem : XElement ) : T_R028_2 = 
        {
            D1_1 =
    ...
    static member private T_Test_toString ( indent : int ) ( indentStep : int ) ( elem : T_Test ) ( elemName : string ) : seq<string> = 
        ...
        seq {
            ...
            yield! ReaderWriter.T_R028_1_toString ( indent + 1 ) indentStep ( elem.R028_1 ) "R028_1"
            yield sprintf "%s</%s>" indentStr elemName
        }

    /// <summary>
    ///  Write T_R028_1 data structure to configuration file.
    /// </summary>
    /// <param name="indent">
    ///  Indent space count.
    /// </param>
    ...
    static member private T_R028_1_toString ( indent : int ) ( indentStep : int ) ( elem : T_R028_1 ) ( elemName : string ) : seq<string> = 
        ...
        seq {
            ...
            | U_R028_2( x ) ->
                yield! ReaderWriter.T_R028_2_toString ( indent + 1 ) indentStep ( x ) "R028_2"
            | U_D2( x ) ->
    ...
    /// <summary>
    ///  Write T_R028_2 data structure to configuration file.
    /// </summary>
    /// <param name="indent">
    ///  Indent space count.
    /// </param>
