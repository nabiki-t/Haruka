...
// Definition of ConfRW_UT002_int configuration reader/writer function.

//=============================================================================
// Namespace declaration

namespace Haruka.Test.UT.ConfRW_002_int
...
///  ConfRW_UT002_int class imprements read and write function of configuration.
type ConfRW_UT002_int() =
...
<xsd:schema xmlns:xsd='http://www.w3.org/2001/XMLSchema'>
  <xsd:element name='Test' >
    ...
    static member LoadFile ( fname : string ) : T_Test =
        fname |> File.ReadAllText |> ConfRW_UT002_int.LoadString
    ...
    static member LoadString ( s : string ) : T_Test =
        ...
        "Test" |> xdoc.Element |> ConfRW_UT002_int.Read_T_Test
    ...
    static member private Read_T_Test ( elem : XElement ) : T_Test = 
        {
            ...
            D3 = 
                ...
                if subElem = null then
                    ...
                    Some( Int32.Parse( subElem.Value ) );
            D4 = 0;
            D5 = 99;
            D6 = 16;
            D7 = 
    ...
    static member WriteFile ( fname : string ) ( d : T_Test ) : unit =
        let s = ConfRW_UT002_int.T_Test_toString 0 2 d "Test"
    ...
    static member ToString ( d : T_Test ) : string =
        ConfRW_UT002_int.T_Test_toString 0 0 d "Test"
        |> String.Concat
    ...
    static member private T_Test_toString ( indent : int ) ( indentStep : int ) ( elem : T_Test ) ( elemName : string ) : seq<string> = 
        ...
        seq {
            ...
            if (elem.D1) < 2 then
                raise <| ConfRWException( "Min value(int) restriction error. D1" )
            if (elem.D1) > 5 then
                raise <| ConfRWException( "Max value(int) restriction error. D1" )
