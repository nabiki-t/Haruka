...
<xsd:schema xmlns:xsd='http://www.w3.org/2001/XMLSchema'>
  ...
  <xsd:complexType name='T029_1'>
    ...
    ///  Array of the generated string.
    /// </returns>
    static member private T_D4_toString ( indent : int32 ) ( indentStep : int32 ) ( elem : T_D4 ) ( elemName : string ) : seq<string> = 
        let indentStr = String.replicate ( indent * indentStep ) " "
        let singleIndent = String.replicate ( indentStep ) " "
        seq {
            yield sprintf "%s<%s>" indentStr elemName
    ...
    ///  Array of the generated string.
    /// </returns>
    static member private T_D5_toString ( indent : int32 ) ( indentStep : int32 ) ( elem : T_D5 ) ( elemName : string ) : seq<string> = 
        let indentStr = String.replicate ( indent * indentStep ) " "
        let singleIndent = String.replicate ( indentStep ) " "
        seq {
            yield sprintf "%s<%s>" indentStr elemName
    ...
    ///  Array of the generated string.
    /// </returns>
    static member private T_T029_1_toString ( indent : int32 ) ( indentStep : int32 ) ( elem : T_T029_1 ) ( elemName : string ) : seq<string> = 
        let indentStr = String.replicate ( indent * indentStep ) " "
        let singleIndent = String.replicate ( indentStep ) " "
        seq {
            yield sprintf "%s<%s>" indentStr elemName
