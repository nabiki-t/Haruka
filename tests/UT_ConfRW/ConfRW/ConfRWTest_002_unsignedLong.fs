...
// Definition of ConfRW_UT002_unsignedLong configuration reader/writer function.

//=============================================================================
// Namespace declaration

namespace Haruka.Test.UT.ConfRW_002_unsignedLong
...
///  ConfRW_UT002_unsignedLong class imprements read and write function of configuration.
type ConfRW_UT002_unsignedLong() =
...
<xsd:schema xmlns:xsd='http://www.w3.org/2001/XMLSchema'>
  <xsd:element name='Test' >
    ...
    static member LoadFile ( fname : string ) : T_Test =
        fname |> File.ReadAllText |> ConfRW_UT002_unsignedLong.LoadString
    ...
    static member LoadString ( s : string ) : T_Test =
        ...
        "Test" |> xdoc.Element |> ConfRW_UT002_unsignedLong.Read_T_Test
    ...
    static member private Read_T_Test ( elem : XElement ) : T_Test = 
        {
            D1 =
                UInt64.Parse( elem.Element( XName.Get "D1" ).Value );
            D2 =
                elem.Elements()
            ...
            D3 = 
                ...
                if subElem = null then
                    ...
                    Some( UInt64.Parse( subElem.Value ) );
            D4 = 0UL;
            D5 = 99UL;
            D6 = 16UL;
            D7 = 
    ...
    static member WriteFile ( fname : string ) ( d : T_Test ) : unit =
        let s = ConfRW_UT002_unsignedLong.T_Test_toString 0 2 d "Test"
    ...
    static member ToString ( d : T_Test ) : string =
        ConfRW_UT002_unsignedLong.T_Test_toString 0 0 d "Test"
        |> String.Concat
    ...
    static member private T_Test_toString ( indent : int ) ( indentStep : int ) ( elem : T_Test ) ( elemName : string ) : seq<string> = 
        ...
        seq {
            ...
            if (elem.D1) < 1UL then
                raise <| ConfRWException( "Min value(unsignedLong) restriction error. D1" )
            if (elem.D1) > 2UL then
                raise <| ConfRWException( "Max value(unsignedLong) restriction error. D1" )
