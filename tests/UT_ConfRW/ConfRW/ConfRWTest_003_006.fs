...
namespace Haruka.Test.UT.ConfRW_003_006
...
<xsd:schema xmlns:xsd='http://www.w3.org/2001/XMLSchema'>
  <xsd:element name='Test' >
    ...
    static member private Read_T_Test ( elem : XElement ) : T_Test = 
        {
            R024_1 =
                ReaderWriter.Read_T_R024_1( elem.Element( XName.Get "R024_1" ) );
        }

    /// <summary>
    ///  Read T_R024_1 data from XML document.
    /// </summary>
    /// <param name="elem">
    ///  Loaded XML document.
    /// </param>
    /// <returns>
    ///  parsed T_R024_1 data structure.
    /// </returns>
    static member private Read_T_R024_1 ( elem : XElement ) : T_R024_1 = 
    ...
    static member private T_Test_toString ( indent : int32 ) ( indentStep : int32 ) ( elem : T_Test ) ( elemName : string ) : seq<string> = 
        ...
        seq {
            ...
            yield! ReaderWriter.T_R024_1_toString ( indent + 1 ) indentStep ( elem.R024_1 ) "R024_1"
            yield sprintf "%s</%s>" indentStr elemName
        }

    /// <summary>
    ///  Write T_R024_1 data structure to configuration file.
    /// </summary>
    /// <param name="indent">
    ///  Indent space count.
    /// </param>
    ...
    ///  Array of the generated string.
    /// </returns>
    static member private T_R024_1_toString ( indent : int32 ) ( indentStep : int32 ) ( elem : T_R024_1 ) ( elemName : string ) : seq<string> = 
        let indentStr = String.replicate ( indent * indentStep ) " "
        let singleIndent = String.replicate ( indentStep ) " "
        seq {
            yield sprintf "%s<%s>" indentStr elemName
