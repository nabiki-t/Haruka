...
// Definition of ConfRW_UT002_GUID configuration reader/writer function.

//=============================================================================
// Namespace declaration

namespace Haruka.Test.UT.ConfRW_002_GUID
...
///  ConfRW_UT002_GUID class imprements read and write function of configuration.
type ConfRW_UT002_GUID() =
...
<xsd:schema xmlns:xsd='http://www.w3.org/2001/XMLSchema'>
  <xsd:element name='Test' >
    ...
    static member LoadFile ( fname : string ) : T_Test =
        fname |> File.ReadAllText |> ConfRW_UT002_GUID.LoadString
    ...
    static member LoadString ( s : string ) : T_Test =
        ...
        "Test" |> xdoc.Element |> ConfRW_UT002_GUID.Read_T_Test
    ...
    static member private Read_T_Test ( elem : XElement ) : T_Test = 
        {
            D1 =
                System.Guid.Parse( elem.Element( XName.Get "D1" ).Value );
            D2 =
                elem.Elements()
                |> Seq.filter ( fun itr -> itr.Name = XName.Get "D2" )
                |> Seq.map ( fun itr -> System.Guid.Parse( itr.Value ) )
                |> Seq.toList
            D3 = 
                ...
                if subElem = null then
                    ...
                    Some( System.Guid.Parse( subElem.Value ) );
            D4 = System.Guid();
            D5 = System.Guid.Parse( "99000000-0000-0000-0000-000000000099" );
            D6 = 
                let subElem = elem.Element( XName.Get "D6" )
                if subElem = null then
                    System.Guid.Parse( "98000000-0000-0000-0000-000000000098" );
                else
                    System.Guid.Parse( subElem.Value );
        }
    ...
    static member WriteFile ( fname : string ) ( d : T_Test ) : unit =
        let s = ConfRW_UT002_GUID.T_Test_toString 0 2 d "Test"
    ...
    static member ToString ( d : T_Test ) : string =
        ConfRW_UT002_GUID.T_Test_toString 0 0 d "Test"
        |> String.Concat
