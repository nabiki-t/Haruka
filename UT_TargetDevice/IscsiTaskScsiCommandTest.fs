...
type IscsiTaskScsiCommand_Test () =
    ...
    member _.isAllDataReceived_001() =
        let dli = [
            ...
            {   IscsiTaskScsiCommand_Test.defaultScisDataOutPDUValues with
                    F = false;
                    DataSN = datasn_me.fromPrim 0u;
                    TargetTransferTag = ttt_me.fromPrim 0x00000000u; };
        ]
    ...
    [<Fact>]
    member _.isAllDataReceived_002() =
        let dli = [
            {   IscsiTaskScsiCommand_Test.defaultScisDataOutPDUValues with
                    F = false;
                    DataSN = datasn_me.fromPrim 2u;
            ...
            {   IscsiTaskScsiCommand_Test.defaultScisDataOutPDUValues with
                    F = true;
                    DataSN = datasn_me.fromPrim 0u;
                    TargetTransferTag = ttt_me.fromPrim 0x00000001u; };
            {   IscsiTaskScsiCommand_Test.defaultScisDataOutPDUValues with
                    F = false;
                    DataSN = datasn_me.fromPrim 0u;
                    TargetTransferTag = ttt_me.fromPrim 0xFFFFFFFFu; };
    ...
    [<Fact>]
    member _.isAllDataReceived_003() =
        let dli = [
            {   IscsiTaskScsiCommand_Test.defaultScisDataOutPDUValues with
                    F = true;
    ...
    [<Fact>]
    member _.isAllDataReceived_004() =
        let dli = [
            {   IscsiTaskScsiCommand_Test.defaultScisDataOutPDUValues with
                    F = true;
                    DataSN = datasn_me.fromPrim 3u;
    ...
    [<Fact>]
    member _.isAllDataReceived_005() =
        let dli = [
            {   IscsiTaskScsiCommand_Test.defaultScisDataOutPDUValues with
                    F = false;
                    DataSN = datasn_me.fromPrim 2u;
    ...
    [<Fact>]
    member _.isAllDataReceived_006() =
        let dli : SCSIDataOutPDU list = []
        let result = PrivateCaller.Invoke< IscsiTaskScsiCommand >( "isAllDataReceived", dli, ttt_me.fromPrim 0xFFFFFFFFu ) :?> bool
        Assert.False( result )

    [<Fact>]
    member _.isAllDataReceived_007() =
        let dli = [
            {   IscsiTaskScsiCommand_Test.defaultScisDataOutPDUValues with
                    F = false;
                    DataSN = datasn_me.fromPrim 2u;
        ...
        let result = PrivateCaller.Invoke< IscsiTaskScsiCommand >( "isAllDataReceived", dli, ttt_me.fromPrim 2u ) :?> bool
        Assert.False( result )

    [<Fact>]
    member _.isAllDataReceived_008() =
        let dli = [
            {   IscsiTaskScsiCommand_Test.defaultScisDataOutPDUValues with
                    F = false;
                    DataSN = datasn_me.fromPrim 0u;
