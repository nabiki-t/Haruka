...
// DummyMediaPropPage.fs : Implement the function to display Dummy Media property page in the main window.
//
...
type DummyMediaPropPage(
    ...
    do
        ...
        m_Config.SetLocalizedText "DummyMediaPropPage" m_PropPage
        ...
        m_UsageExpander.Expanded.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "DummyMediaPropPage" m_UsageExpander.Name true )
        m_UsageExpander.Collapsed.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "DummyMediaPropPage" m_UsageExpander.Name false )
        m_ConfigurationExpander.Expanded.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "DummyMediaPropPage" m_ConfigurationExpander.Name true )
        m_ConfigurationExpander.Collapsed.AddHandler ( fun _ _ -> UserOpeStat.SetExpanded "DummyMediaPropPage" m_ConfigurationExpander.Name false )
        ...
        // Set default value
        m_UsageExpander.IsExpanded <- UserOpeStat.GetExpanded "DummyMediaPropPage" m_UsageExpander.Name
        m_ConfigurationExpander.IsExpanded <- UserOpeStat.GetExpanded "DummyMediaPropPage" m_ConfigurationExpander.Name
    ...
    member private this.OnClick_ApplyButton() : unit = 
        try
            let mn = m_ServerStatus.GetNode m_NodeID :?> ConfNode_DummyMedia
            ...
            let newNode = m_ServerStatus.UpdateDummyMediaNode mn ( mediaidx_me.fromPrim identNumber ) mediaName
            this.ShowConfigValue false false
